...
<script type="text/javascript">
        ...
        $('#sqsAddForm').form({
            ...
            success: function (result) {
                ...
                if (result.success) {
                    ...
                    location.href = "${path}/sqs/app/info?guid=${guid}";
                } else {
    ...
    function changeAgentFei() {
        ...
        if (isNaN(guifei) || isNaN(pice)) {
            ...
            $("#agentFei").val(parseInt(pice) - parseInt(guifei));
        }
    }
</script>
    ...
    <div data-options="region:'center',border:false" title="商标注册申请书-添加"
        ...
        <form id="sqsAddForm" method="post" enctype=”multipart/form-data”>
            ...
            <table class="grid">
                ...
                <tr>
                    <td>规费</td>
                    <td><input name="guiFei" id="guiFei" class="easyui-validatebox" type="text"></td>
                    <td>总费用</td>
