...
import com.gt.ms.utils.Charsets;
 ...
 *
 */
@Component("ueditorManager")
public class UeditorManager implements IUeditorManager {
	...
	public void afterPropertiesSet() throws Exception {
		...
		try {
			...
			jsonConfig = JsonUtil.parse(filter(configContent), UeditorConfig.class);
		} finally {
