/**
 *
 * 本文件及其相关文件为wfshake系统程序，版权属于北京快乐格子信息技术有限公司，受中国及国际相关法律保护�?
 * copyright 2012 www.kuailegezi.com email: 1534928992@qq.com
 *
 * @author 张杰
 * @date 2012/08/24
 */
 ...
 * 反射工具�?
 *
 * 提供访问私有变量,获取泛型类型Class, 提取集合中元素的属�?, 转换字符串到对象等Util函数.
 *
 */
public class ReflectionUtils {
    ...
    /**
     * 提取集合中的对象的属�?通过getter函数), 组合成由分割符分隔的字符�?
     *
     * @param collection
     *            来源集合.
     * @param propertyName
    ...
    // public static Object convertStringToObject(String propertyTypeCode,
    // String value) {
