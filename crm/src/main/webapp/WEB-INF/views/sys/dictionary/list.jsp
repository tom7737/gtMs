    ...
    <script type="text/javascript">
            ...
            dataGrid = $('#dataGrid').datagrid({
                ...
                columns: [[{
                    ...
                    formatter: function (value, row, index) {
                        var str = '';
                        str += $.formatString('<a href="javascript:void(0)" class="user-easyui-linkbutton-search" data-options="plain:true,iconCls:\'icon-edit\'" onclick="infoFun(\'{0}\');"  >查看</a>', row.id);
                        str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
        ...
        function infoFun(id) {
            parent.$.modalDialog({
                ...
                width: 500,
                height: 300,
                href: '${path }/dictionary/info?id=' + id,
                buttons: [{
                    text: '确定',
                    handler: function () {
...
<div data-options="region:'center',border:true,title:'数据字典列表'">
