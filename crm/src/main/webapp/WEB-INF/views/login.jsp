...
<head>
    ...
    <script type="text/javascript">
        ...
        function changeImg(){
                 ...
                 img.src = "${path}/verifyCode/generate?date=" + new Date();;
                }
...
<div style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 250px; text-align: center;">
    <form method="post" id="loginform">
        ...
        <P style="position: relative;">
            ...
            <input class="verify"  id="verifyCode" onfocus="" type="username" name="verifyCode" placeholder="请输入验证码" value="" />
            <img id="img" src="${path}/verifyCode/generate" style="    width: 130px;
    /* margin-top: 5px; */
    display: inline-block;
    position: relative;
    top: 10px;"/>
            <a href="#" onclick="changeImg()" style="color:white; display: inline-block;"><label style="color:black;">换一张？</label></a>
        </P>
