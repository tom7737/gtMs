...
public class FileType {
	...
	private static void getAllFileType() {
		FILE_TYPE_MAP.put("ffd8ffe13ffe45786966", "jpg"); // JPEG (jpg)
		FILE_TYPE_MAP.put("ffd8ffe1001845786966", "jpg"); // JPEG (jpg)
...
//			System.out.println(fileCode);
	...
	public static String getFileType(byte[] b) {
		byte[] bt = new byte[10];
		System.arraycopy(b, 0, bt, 0, 10);
		String res = null;
		String fileCode = bytesToHexString(bt);
//		System.out.println(fileCode);
		// 这种方法在字典的头代码不够位数的时候可以用但是速度相对慢一点
		Iterator<String> keyIter = FILE_TYPE_MAP.keySet().iterator();
		while (keyIter.hasNext()) {
	...
	public static void main(String[] args) throws Exception {
		...
		String type = getFileType("C:/Users/admin/Desktop/流程图.pdf");
		System.out.println("流程图.pdf : " + type);
		System.out.println();

		type = getFileType("E:/帐号.xlsx");
		System.out.println("帐号.xlsx : " + type);
		System.out.println();
